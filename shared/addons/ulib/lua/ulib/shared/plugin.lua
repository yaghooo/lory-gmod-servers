...
local ulibBuildNumURL =
	ULib.RELEASE and "https://teamulysses.github.io/ulib/ulib.build" or
	"https://raw.githubusercontent.com/TeamUlysses/ulib/master/ulib.build"
ULib.registerPlugin {
	Name = "ULib",
