...
SWEP.PrintName = "Butterfly Knife" .. " | " .. "Doppler Ruby"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_butterfly_doppler_ruby"
...
SWEP.Icon = "vgui/entities/csgo_butterfly_doppler_ruby.vmt"
