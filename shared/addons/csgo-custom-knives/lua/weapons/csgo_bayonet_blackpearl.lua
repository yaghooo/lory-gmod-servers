...
SWEP.PrintName = "Bayonet Knife" .. " | " .. "Doppler Blackpearl"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_bayonet_doppler_blackpearl"
...
SWEP.Icon = "vgui/entities/csgo_bayonet_blackpearl.vmt"
