...
SWEP.PrintName = "M9 Bayonet Knife" .. " | " .. "Doppler Phase 2"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/m9_doppler_phase2"
...
SWEP.Icon = "vgui/entities/csgo_m9_doppler_phase2.vmt"
