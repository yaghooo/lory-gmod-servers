...
SWEP.PrintName = "Bayonet Knife" .. " | " .. "Doppler Phase 1"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_bayonet_doppler_phase1"
...
SWEP.Icon = "vgui/entities/csgo_bayonet_doppler_phase1.vmt"
