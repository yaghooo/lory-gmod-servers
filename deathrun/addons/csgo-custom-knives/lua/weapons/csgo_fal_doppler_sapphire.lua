...
SWEP.PrintName = "Falchion Knife" .. " | " .. "Doppler Sapphire"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_fal_doppler_sapphire"
...
-- If AutoSpawnable is true and SWEP.Kind is not 01/2, then this gun can
...
SWEP.Icon = "vgui/entities/csgo_fal_doppler_sapphire.vmt"
