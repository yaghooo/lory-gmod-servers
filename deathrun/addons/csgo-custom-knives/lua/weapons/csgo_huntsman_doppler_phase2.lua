...
SWEP.PrintName = "Huntsman Knife" .. " | " .. "Doppler Phase 2"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/huntsman_doppler_phase2"
...
SWEP.Icon = "vgui/entities/csgo_huntsman_doppler_phase2.vmt"
