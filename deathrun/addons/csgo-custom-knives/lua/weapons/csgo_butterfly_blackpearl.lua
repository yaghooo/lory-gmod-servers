...
SWEP.PrintName = "Butterfly Knife" .. " | " .. "Doppler Blackpearl"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_butterfly_doppler_blackpearl"
...
SWEP.Icon = "vgui/entities/csgo_butterfly_doppler_blackpearl.vmt"
