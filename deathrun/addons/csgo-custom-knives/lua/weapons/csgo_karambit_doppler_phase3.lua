...
SWEP.PrintName = "Karambit" .. " | " .. "Doppler Phase 3"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/karambit_doppler_phase3"
...
SWEP.Icon = "vgui/entities/csgo_karambit_doppler_phase3.vmt"
