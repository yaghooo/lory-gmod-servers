...
SWEP.PrintName = "Flip Knife" .. " | " .. "Doppler Phase 4"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/flipknife_doppler_phase4"
...
SWEP.Icon = "vgui/entities/csgo_flip_doppler_phase4.vmt"
