...
SWEP.PrintName = "Bowie Knife" .. " | " .. "Doppler Sapphire"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/bowie_doppler_sapphire"
...
SWEP.Icon = "vgui/entities/csgo_bowie_doppler_sapphire.vmt"
