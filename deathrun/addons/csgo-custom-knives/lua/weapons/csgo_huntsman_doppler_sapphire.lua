...
SWEP.PrintName = "Huntsman Knife" .. " | " .. "Doppler Sapphire"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/huntsman_doppler_sapphire"
...
SWEP.Icon = "vgui/entities/csgo_huntsman_doppler_sapphire.vmt"
