...
SWEP.PrintName = "Falchion Knife" .. " | " .. "Doppler Blackpearl"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_fal_doppler_blackpearl"
...
SWEP.Icon = "vgui/entities/csgo_falchion_blackpearl.vmt"
