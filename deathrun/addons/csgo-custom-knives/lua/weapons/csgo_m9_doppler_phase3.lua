...
SWEP.PrintName = "M9 Bayonet Knife" .. " | " .. "Doppler Phase 3"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/m9_doppler_phase3"
...
SWEP.Icon = "vgui/entities/csgo_m9_doppler_phase3.vmt"
