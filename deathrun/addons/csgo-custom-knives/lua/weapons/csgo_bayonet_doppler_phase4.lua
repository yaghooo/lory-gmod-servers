...
SWEP.PrintName = "Bayonet Knife" .. " | " .. "Doppler Phase 4"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_bayonet_doppler_phase4"
...
SWEP.Icon = "vgui/entities/csgo_bayonet_doppler_phase4.vmt"
