...
SWEP.PrintName = "Karambit" .. " | " .. "Doppler Phase 4"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/karambit_doppler_phase4"
...
SWEP.Icon = "vgui/entities/csgo_karambit_doppler_phase4.vmt"
