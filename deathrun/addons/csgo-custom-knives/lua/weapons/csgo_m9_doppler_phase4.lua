...
SWEP.PrintName = "M9 Bayonet Knife" .. " | " .. "Doppler Phase 4"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/m9_doppler_phase4"
...
SWEP.Icon = "vgui/entities/csgo_m9_doppler_phase4.vmt"
