...
SWEP.PrintName = "Huntsman Knife" .. " | " .. "Doppler Ruby"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/huntsman_doppler_ruby"
...
SWEP.Icon = "vgui/entities/csgo_huntsman_doppler_ruby.vmt"
