...
SWEP.PrintName = "M9 Bayonet Knife" .. " | " .. "Doppler Blackpearl"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/m9_doppler_blackpearl"
...
SWEP.Icon = "vgui/entities/csgo_m9_blackpearl.vmt"
