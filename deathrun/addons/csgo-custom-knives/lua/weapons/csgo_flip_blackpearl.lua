...
SWEP.PrintName = "Flip Knife" .. " | " .. "Doppler Blackpearl"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/flipknife_doppler_blackpearl"
...
SWEP.Icon = "vgui/entities/csgo_flip_blackpearl.vmt"
