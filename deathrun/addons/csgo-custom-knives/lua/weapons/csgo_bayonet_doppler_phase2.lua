...
SWEP.PrintName = "Bayonet Knife" .. " | " .. "Doppler Phase 2"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_bayonet_doppler_phase2"
...
SWEP.Icon = "vgui/entities/csgo_bayonet_doppler_phase2.vmt"
