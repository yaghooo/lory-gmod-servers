...
SWEP.PrintName = "Karambit" .. " | " .. "Doppler Blackpearl"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/karambit_doppler_blackpearl"
...
SWEP.Icon = "vgui/entities/csgo_karambit_blackpearl.vmt"
