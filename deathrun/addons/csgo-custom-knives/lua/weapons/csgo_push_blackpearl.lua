...
SWEP.PrintName = "Shadow Daggers" .. " | " .. "Doppler Blackpearl"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_push_doppler_blackpearl"
...
SWEP.Icon = "vgui/entities/csgo_push_blackpearl"
