...
SWEP.PrintName = "Karambit" .. " | " .. "Doppler Phase 1"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/karambit_doppler_phase1"
...
SWEP.Icon = "vgui/entities/csgo_karambit_doppler_phase1.vmt"
