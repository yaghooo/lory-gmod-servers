...
SWEP.PrintName = "Huntsman Knife" .. " | " .. "Doppler Phase 4"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/huntsman_doppler_phase4"
...
SWEP.Icon = "vgui/entities/csgo_huntsman_doppler_phase4.vmt"
