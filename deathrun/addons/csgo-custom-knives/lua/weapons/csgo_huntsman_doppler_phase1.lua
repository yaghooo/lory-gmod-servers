...
SWEP.PrintName = "Huntsman Knife" .. " | " .. "Doppler Phase 1"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/huntsman_doppler_phase1"
...
SWEP.Icon = "vgui/entities/csgo_huntsman_doppler_phase1.vmt"
