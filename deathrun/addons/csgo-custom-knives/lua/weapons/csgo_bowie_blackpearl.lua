...
SWEP.PrintName = "Bowie Knife" .. " | " .. "Doppler Blackpearl"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/bowie_doppler_blackpearl"
...
SWEP.Icon = "vgui/entities/csgo_bowie_blackpearl.vmt"
