...
SWEP.PrintName = "M9 Bayonet Knife" .. " | " .. "Doppler Phase 1"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/m9_doppler_phase1"
...
SWEP.Icon = "vgui/entities/csgo_m9_doppler_phase1.vmt"
