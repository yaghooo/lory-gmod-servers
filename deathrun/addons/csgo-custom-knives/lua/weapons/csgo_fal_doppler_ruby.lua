...
SWEP.PrintName = "Falchion Knife" .. " | " .. "Doppler Ruby"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_fal_doppler_ruby"
...
SWEP.Icon = "vgui/entities/csgo_fal_doppler_ruby.vmt"
