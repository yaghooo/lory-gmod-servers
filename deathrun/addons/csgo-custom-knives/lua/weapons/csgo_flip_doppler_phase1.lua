...
SWEP.PrintName = "Flip Knife" .. " | " .. "Doppler Phase 1"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/flipknife_doppler_phase1"
...
SWEP.Icon = "vgui/entities/csgo_flip_doppler_phase1.vmt"
