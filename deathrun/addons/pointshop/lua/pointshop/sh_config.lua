...
PS.Config.CommunityName = "DEVSHOP"
...
PS.Config.LootChance = 0.04
PS.Config.CrateItemQuantity = 200

PS.Config.PointsOverTime = true -- Should players be given points over time?
PS.Config.PointsOverTimeDelay = 3 -- If so, how many minutes apart?
PS.Config.PointsOverTimeAmount = 60 -- And if so, how many points to give after the time?
...
PS.Config.PointsName = "Bitcoin" -- What are the points called?
