...
local function init()
	if ULib.isSandbox() then --Only execute the following code if it's a sandbox gamemode
		...
		ULib.replicatedWritableCvar(
			"physgun_limited",
			"rep_physgun_limited",
			GetConVarNumber("physgun_limited"),
			false,
			false,
			"xgui_gmsettings"
		)
		...
		ULib.replicatedWritableCvar(
			...
			"rep_sbox_playershurtplayers",
			GetConVarNumber("sbox_playershurtplayers"),
			false,
			false,
			"xgui_gmsettings"
		)
		...
		ULib.replicatedWritableCvar(
			"sbox_bonemanip_misc",
			"rep_sbox_bonemanip_misc",
			GetConVarNumber("sbox_bonemanip_misc"),
			false,
			false,
			"xgui_gmsettings"
		)
		ULib.replicatedWritableCvar(
			"sbox_bonemanip_npc",
			"rep_sbox_bonemanip_npc",
			GetConVarNumber("sbox_bonemanip_npc"),
			false,
			false,
			"xgui_gmsettings"
		)
		ULib.replicatedWritableCvar(
			...
			"rep_sbox_bonemanip_player",
			GetConVarNumber("sbox_bonemanip_player"),
			false,
			false,
			"xgui_gmsettings"
		)
