...
SWEP.PrintName = "Bayonet Knife" .. " | " .. "Doppler Sapphire"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_bayonet_doppler_sapphire"
...
SWEP.Icon = "vgui/entities/csgo_bayonet_doppler_sapphire.vmt"
