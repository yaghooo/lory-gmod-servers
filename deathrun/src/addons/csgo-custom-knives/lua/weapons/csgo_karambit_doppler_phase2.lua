...
SWEP.PrintName = "Karambit" .. " | " .. "Doppler Phase 2"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/karambit_doppler_phase2"
...
SWEP.Icon = "vgui/entities/csgo_karambit_doppler_phase2.vmt"
