...
SWEP.PrintName = "Shadow Daggers" .. " | " .. "Doppler Sapphire"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_push_doppler_sapphire"
...
SWEP.Icon = "vgui/entities/csgo_push_doppler_sapphire.vmt"
