...
SWEP.PrintName = "Huntsman Knife" .. " | " .. "Doppler Blackpearl"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/huntsman_doppler_blackpearl"
...
SWEP.Icon = "vgui/entities/csgo_huntsman_blackpearl.vmt"
