...
SWEP.PrintName = "Shadow Daggers" .. " | " .. "Doppler Phase 1"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_push_doppler_phase1"
...
SWEP.Icon = "vgui/entities/csgo_push_doppler_phase1.vmt"
