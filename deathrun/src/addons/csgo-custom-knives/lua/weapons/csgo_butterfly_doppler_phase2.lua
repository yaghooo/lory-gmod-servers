...
SWEP.PrintName = "Butterfly Knife" .. " | " .. "Doppler Phase 2"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_butterfly_doppler_phase2"
...
SWEP.Icon = "vgui/entities/csgo_butterfly_doppler_phase2.vmt"
