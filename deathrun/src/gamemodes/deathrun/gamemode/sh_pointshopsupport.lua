            ...
            if amt <= storemoney then
                ...
                if PointshopRewardMessage:GetBool() then
                    ply:DeathrunChatPrint(
                        "You were given " .. tostring(amt) .. " points for " .. (reason or "playing") .. "!"
                    )
                end
            else
                if PointshopRewardMessage:GetBool() then
