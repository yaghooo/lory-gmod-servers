...
SWEP.PrintName = "Flip Knife" .. " | " .. "Doppler Phase 2"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/flipknife_doppler_phase2"
...
SWEP.Icon = "vgui/entities/csgo_flip_doppler_phase2.vmt"
