...
SWEP.PrintName = "Shadow Daggers" .. " | " .. "Doppler Ruby"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_push_doppler_ruby"
...
SWEP.Icon = "vgui/entities/csgo_push_doppler_ruby.vmt"
