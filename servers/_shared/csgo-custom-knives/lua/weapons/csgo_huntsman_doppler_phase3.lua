...
SWEP.PrintName = "Huntsman Knife" .. " | " .. "Doppler Phase 3"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/huntsman_doppler_phase3"
...
SWEP.Icon = "vgui/entities/csgo_huntsman_doppler_phase3.vmt"
