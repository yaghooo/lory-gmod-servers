...
SWEP.PrintName = "Karambit" .. " | " .. "Doppler Sapphire"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/karambit_doppler_sapphire"
...
SWEP.Icon = "vgui/entities/csgo_karambit_doppler_sapphire.vmt"
