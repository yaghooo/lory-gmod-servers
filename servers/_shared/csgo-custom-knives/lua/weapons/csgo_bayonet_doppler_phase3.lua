...
SWEP.PrintName = "Bayonet Knife" .. " | " .. "Doppler Phase 3"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_bayonet_doppler_phase3"
...
SWEP.Icon = "vgui/entities/csgo_bayonet_doppler_phase3.vmt"
