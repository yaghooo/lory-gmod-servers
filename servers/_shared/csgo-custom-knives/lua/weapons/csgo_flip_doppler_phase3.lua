...
SWEP.PrintName = "Flip Knife" .. " | " .. "Doppler Phase 3"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/flipknife_doppler_phase3"
...
SWEP.Icon = "vgui/entities/csgo_flip_doppler_phase3.vmt"
