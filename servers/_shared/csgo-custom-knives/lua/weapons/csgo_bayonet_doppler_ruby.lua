...
SWEP.PrintName = "Bayonet Knife" .. " | " .. "Doppler Ruby"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_bayonet_doppler_ruby"
...
SWEP.Icon = "vgui/entities/csgo_bayonet_doppler_ruby.vmt"
