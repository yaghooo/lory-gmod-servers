...
-- Ensure the connection will be made after loading CFG files
timer.Simple(0, function()
    local connection = {mysql_hostname:GetString(), mysql_username:GetString(), mysql_password:GetString(), mysql_database:GetString(), mysql_port}
    print("MySQL Credentials:")
    PrintTable(connection)
    db = mysqloo.connect(unpack(connection))
