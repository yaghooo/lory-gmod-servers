...
SWEP.PrintName = "Flip Knife" .. " | " .. "Doppler Sapphire"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/flipknife_doppler_sapphire"
...
SWEP.Icon = "vgui/entities/csgo_flip_doppler_sapphire.vmt"
