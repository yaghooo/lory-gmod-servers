...
SWEP.PrintName = "Butterfly Knife" .. " | " .. "Doppler Sapphire"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/knife_butterfly_doppler_sapphire"
...
SWEP.Icon = "vgui/entities/csgo_butterfly_sapphire.vmt"
