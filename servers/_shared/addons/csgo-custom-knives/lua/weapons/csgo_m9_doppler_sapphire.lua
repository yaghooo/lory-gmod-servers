...
SWEP.PrintName = "M9 Bayonet Knife" .. " | " .. "Doppler Sapphire"
...
SWEP.SkinIndex = nil
SWEP.PaintMaterial = "models/csgo_knife/m9_doppler_sapphired"
...
SWEP.Icon = "vgui/entities/csgo_m9_doppler_sapphire.vmt"
